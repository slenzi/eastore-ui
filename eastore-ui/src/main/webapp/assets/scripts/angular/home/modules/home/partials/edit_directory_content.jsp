	...
	<md-content layout-padding >
		...
		<div>
			<form name="dirForm">
				...
				<md-input-container class="md-block">
					<md-button class="md-raised standardButton" ng-click="dirCtrl.cancelEdit(dirCtrl.store, dirCtrl.directory)">
					Cancel
					</md-button>				
					<md-button class="md-raised standardButton" ng-click="dirCtrl.doEditDirectory(dirCtrl.store, dirCtrl.directory)">
					Submit
					</md-button>
				</md-input-container>
